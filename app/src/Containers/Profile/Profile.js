    ...
    render() {
        return (
            <ScrollView style={Style.ProfileContainer}>
                <ImageBackground source={Images.ProfileBannerImg} style={Style.ProfileHeaderContainer}>
                    ...
                    <View style={Style.ProfileHeaderAvatarContainer}>
                        <View style={Style.ProfileHeaderAvatarWrap}>
                            <Image source={Images.femaleProfile} style={Style.ProfileHeaderAvatarImg} />
                ...
                <View style={Style.ProfileBtnGroupContainer}>
                    <View style={Style.ProfileBtnGroupWrap}>
                        <View style={Style.ProfileBtnPublishedContainer}>
                            <Image source={Images.ProfileBtnPublished} style={Style.ProfileBtnPublishedImg} />
                            <Text>已发布</Text>
                        </View>
                        <View style={Style.ProfileLikeContainer}>
                            <Image source={Images.ProfileBtnLike} style={Style.ProfileBtnLikeImg} />
                            <Text>赞过</Text>
                        </View>
                        <View style={Style.ProfileAttentionContainer}>
                            <Image source={Images.ProfileBtnAttention} style={Style.ProfileBtnAttentionImg} />
                            <Text>关注</Text>
                        </View>
                    </View>
                </View>
                    ...
                    <View style={Style.ProfileUpdateContainer}>
                        <View style={Style.ProfileUpdateWrap}>
                            <View style={Style.ProfileUpdateLeft}>
                                <Image source={Images.ProfileUpdate} style={Style.ProfileUpdateImg} />
                                <Text>检查更新</Text>
                            </View>
                            <View style={Style.ProfileUpdateRight}>
                                <Image source={Images.RightArrow} style={Style.ProfileRightArrow} />
                            </View>
                        </View>
                    </View>
                    <View style={Style.ProfileContactUsContainer}>
                        <View style={Style.ProfileContactUsWrap}>
                            <View style={Style.ProfileContactUsLeft}>
                                <Image source={Images.ProfileContactus} style={Style.ProfileContactUsImg} />
                                <Text>联系我们</Text>
                            </View>
                            <View style={Style.ProfileContactUsRight}>
                                <Image source={Images.RightArrow} style={Style.ProfileRightArrow} />
                            </View>
                        </View>
                    </View>
