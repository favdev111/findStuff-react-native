...
import { View, ScrollView, StyleSheet, Dimensions, Image, Text, SectionList} from 'react-native'
      ...
      <View style={Styles.AttentionContainer}>
         <SectionList
            sections={[
               ...
               {title: 'C', data: ['Cackson', 'Cames', 'Cillian', 'Cimmy', 'Cel', 'Cohn', 'Culie']},
            ]}
            renderItem={({item}) => 
               <View style={Styles.AttentionListWrap}>
                  <View style={Styles.AttentionListImgContainer}>
                     <Image source={Images.maleProfile} style={{width: 35, height: 35}} />
                  ...
                  <View style={Styles.AttentionListBtnContainer}>
                     <Image source={Images.EachAttention} style={Styles.AttentionListBtn} />
                  </View>
               </View>
            }
