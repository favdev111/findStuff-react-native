  ...
  return (
    <ScrollView style={Styles.GetStuffScreenContainer}>
      <View style={Styles.FindStuffHeaderContainer}>
        ...
        <Text style={{fontSize: 20, color: '#fff'}}>News Detail</Text>
        <Text style={{flex: 1}} />
      </View>
      <View style={Styles.MessageDetailContainer}>
        <View style={Styles.LastMessageContainer}>
          <View style={Styles.LastMessageDescription}>
            <Text style={Styles.LastMessageDescriptionText}>
              ABC 123 sdafsdf sdfasfsadf sfsafasfasf
              asdfasfasdfasfasdfsfasfasfasfasfd
            </Text>
          </View>
        </View>
      </View>
