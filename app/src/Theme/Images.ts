...
export default {
  ...
  HomeNewsBtn: require('src/Images/HomeBtnGroup/HomeNewsBtn.png'),
  HomeMapBtn: require('src/Images/HomeBtnGroup/HomeMapBtn.png'),
  FindBtnBadge: require('src/Images/HomeBtnGroup/FindBtnBadge.png'),
  GetBtnBadge: require('src/Images/HomeBtnGroup/GetBtnBadge.png'),
  ...
  BottomNavHome2: require('src/Images/BottomTabIcon/BottomNavHome2.png'),
  BottomNavNews2: require('src/Images/BottomTabIcon/LC_icon_bell_fill_1.png'),
  BottomNavProfile2: require('src/Images/BottomTabIcon/LC_icon_profile_fill_1.png'),
  BottomNavChat2: require('src/Images/BottomTabIcon/LC_icon_chat_fill_1.png'),
  // Card Avartars
  ...
  RedSound: require('src/Images/Icons/RedSound.png'),
