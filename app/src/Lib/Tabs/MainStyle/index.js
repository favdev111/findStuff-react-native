...
var ThemeProvider = (exports.ThemeProvider = function ThemeProvider(props) {
  ...
  return _react2['default'].createElement(ThemeContext.Provider, {value: theme}, props.children)
})
...
var WithTheme = (exports.WithTheme = (function(_React$Component) {
  ...
  function WithTheme() {
    ...
    var _this = (0, _possibleConstructorReturn3['default'])(
      this,
      (WithTheme.__proto__ || Object.getPrototypeOf(WithTheme)).apply(this, arguments),
    )

    _this.getStyles = function(theme) {
      var _this$props = _this.props
      var themeStyles = _this$props.themeStyles
